<%@ Page Title="" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="Look4Home.EditProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <title>Edit Your Profile</title>
    <link rel="stylesheet" href="css/main.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <fieldset><legend>Update Your Details</legend></fieldset>
    <table>
        ...
        <tr>
            <td>
                <fieldset>
                    ...
                    <div>
                        <asp:TextBox ID="first_name" runat="server" placeholder="First Name" MaxLength="10" />
                    ...
                    <div>
                        <asp:TextBox ID="last_name" runat="server" placeholder="Last Name" MaxLength="10" />
            ...
            <td>
                <fieldset>
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_mobile" runat="server" ErrorMessage="* Required"
                            ForeColor="#FF3300" ControlToValidate="Mobile"></asp:RequiredFieldValidator>
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator_Address" runat="server" ErrorMessage="* Required"
    ...
    <table>
        <tr>
          ...
          <br />
                <asp:Button ID="Edit" Text="Want to Edit" runat="server" OnClick="Edit_Click" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
